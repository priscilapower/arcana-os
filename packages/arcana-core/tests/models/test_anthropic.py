...
def test_api_key_resolution_precedence(monkeypatch):
    ...
    with patch("keyring.get_password", return_value="kr-key"):
    ...
    with patch("keyring.get_password", side_effect=_kr_conn):
        monkeypatch.setenv(env_var, "env-key")
    ...
    with patch("keyring.get_password", side_effect=_kr_none):
        monkeypatch.setenv(env_var, "env-key")
    ...
    with patch("keyring.get_password", side_effect=_kr_provider):
